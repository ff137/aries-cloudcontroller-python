...
from aries_cloudcontroller.models.txn_or_credential_definition_send_result_txn import TxnOrCredentialDefinitionSendResultTxn
...
class TxnOrCredentialDefinitionSendResult(BaseModel):
    ...
    txn: Optional[TxnOrCredentialDefinitionSendResultTxn] = Field(alias="txn", default=None)
